  ...
  return (
    <div className="max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h2 className="text-3xl font-bold text-slate-800">Public Vocabulary Sets</h2>
          <p className="text-base text-slate-500 mt-1">Manage public vocabulary sets on the system.</p>
        </div>
      ...
      {loading && !hasSets ? (
        ...
        <EmptyState
          title="No sets yet"
          description="Create your first public vocabulary set."
          action={
            <button
              onClick={() => navigate("/admin/vocabulary/new")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <CreateSetCard onClick={() => navigate("/admin/vocabulary/new")} />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 px-4">
          <div className="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl border border-slate-200">
            <div className="flex items-start justify-between gap-4 mb-6">
              <div>
                <h3 className="text-2xl font-bold text-slate-800">Create New Public Set</h3>
                <p className="text-sm text-slate-500 mt-1">Start a new library set for public vocabulary.</p>
              </div>
              <button
